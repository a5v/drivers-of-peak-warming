...
def varying_g_peak_warming_calculator(consumption_discount=0.035,
    ...
    for iteration in range(num_of_iterations):
        ...
        SCC_calculated = calculate_SCC_for_perturbed_years(T_TCRE, T_forecasted_iteration, years_forecasted_length,
...
def create_W_forecast(T_forecast_years, g, last_historical_year, start_year):
    W_2019 = 80
    W = []
